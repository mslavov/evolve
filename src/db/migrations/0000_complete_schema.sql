...
CREATE INDEX `eval_agent_idx` ON `eval_datasets` (`agent_id`);--> statement-breakpoint
CREATE INDEX `eval_agent_version_idx` ON `eval_datasets` (`agent_id`, `agent_version`);--> statement-breakpoint
